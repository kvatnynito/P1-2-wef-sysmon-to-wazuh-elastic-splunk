...
Evidence screenshots from completed steps. Each image proves a specific validation claim.
...
![SIEM-SPLUNK01 IP address confirmed at 10.10.10.20](step06-siem-splunk01-ip-confirmed.png)
...
![Splunk service running on SIEM-SPLUNK01](step06-splunk-service-running.png)
...
![Splunk Web UI reachable from TEST-WIN10-LAN1](step06-splunk-web-ui-reachable-from-win10.png)
...
![Splunk UDP 5514 input created successfully](step06-splunk-udp5514-input-configured.png)
...
![pfSense remote logging configured to 10.10.10.20:5514](step06-pfsense-remote-logging-configured-udp5514.png)
...
![Splunk search returning 901 pfSense syslog events](step06-splunk-pfsense-events-visible.png)
...
![Splunk TCP 9997 receiving port enabled](step06-splunk-tcp9997-receiving-enabled.png)
...
![Splunk search returning Windows Security events from TEST-WIN10-LAN1](step06-splunk-windows-events-visible.png)
...
![WEC01 Server Manager showing corp.local domain membership](step07-wec01-domain-membership-confirmed.png)
...
![WEC01 PowerShell validation for domain controller discovery and network settings](step07-wec01-domain-dc-network-validation.png)
...
![TEST-WIN10-LAN1 domain login, domain membership, DHCP, DNS, and corp.local resolution validated](step07-test-win10-lan1-domain-dns-validated.png)
...
![TEST-WIN10-LAN1 can reach WEC01 on WinRM TCP 5985](step07-test-win10-lan1-wec01-winrm-5985-reachable.png)
